 ...
 */
public class LargeRegionEnumerate {
    ...
    public static void main(final String[] args) {
        ...
        final KTable<String, Long> userRegions = builder.table("LargeRegions");

        final KStream<String, Long> regionsStream = userRegions
                .toStream();
        ...
        regionsStream.to("RegionsEnum", Produced.with(stringSerde, longSerde));
